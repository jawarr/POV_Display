...
uint8_t font_G[5] = {0x1F, 0x11, 0x11, 0x15, 0x1D};
...
uint8_t font_degree[5]   = {0x00, 0x00, 0x03, 0x03, 0x00}; // °
...
const uint8_t* get_font(char c) {
    switch (c) {
        ...
        case '~': return font_degree; //use a tilda for displaying degree symbol
